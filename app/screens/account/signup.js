                ...
                <>
                  <InputWrapper>
                    ...
                    {touched.firstname && errors.firstname && (
                      <AText color="red" xtrasmall>{errors.firstname}</AText>
                    )}
                  </InputWrapper>
                  <InputWrapper>
                    ...
                    {touched.lastname && errors.lastname && (
                      <AText color="red" xtrasmall>{errors.lastname} </AText>
                    )}
                  </InputWrapper>
                  <InputWrapper>
                  ...
                  <InputWrapper>
                    ...
                    {touched.mobile && errors.mobile && (
                      <AText color="red" xtrasmall>{errors.mobile}</AText>
                    )}
                  </InputWrapper>
                  <InputWrapper>
                  ...
                  <InputWrapper>
                    ...
                    {touched.confirm_password && errors.confirm_password && (
                      <AText color="red" xtrasmall>{errors.confirm_password}</AText>
                    )}
                  </InputWrapper>
